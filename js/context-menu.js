...
/** @typedef {{ label: string, run: (id: string) => void }} ContextMenuItem */
 ...
 * @returns {{ open: (id: string, x: number, y: number) => void, close: () => void, destroy: () => void }}
 */
export function createContextMenu(container, items) {
