 ...
 * @param {number} current   Current star rating (0 = none/unrated).
 * @param {number} fraction  Fraction of the test answered correctly, 0–1.
 * @param {number} max       Maximum stars (e.g. 10).
 * @returns {number}
 */
export function combineRating(current, fraction, max) {
