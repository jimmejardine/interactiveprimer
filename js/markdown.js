 ...
 * @param {string} text  An HTML-escaped string.
 * @returns {string}
 */
...
export function renderMarkdown(md) {
  ...
  /** @type {string[]} */
  const out = [];
  /** @type {number[]} Indent width at each currently-open <ul>. */
  const listStack = [];
  /** @type {string[]} Lines of the paragraph currently being accumulated. */
  let para = [];
