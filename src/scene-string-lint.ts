...
function stripEscaped(value: string): string {
 ...
 */
export function placeholderNames(value: string): Set<string> {
 ...
 * @param value
 * @param varNames Declared quiz variable names on the page.
 * @returns The offending inner-expressions (e.g. `["10*t + o"]`); empty when clean.
 */
export function expressionPlaceholders(value: string, varNames: Set<string> | Iterable<string>): string[] {
