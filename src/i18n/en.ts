...
const en: Record<string, string> = {
  ...
  "menu.getStarted": "Find your place",

  "getstarted.docTitle": "Find your place — Interactive Primer",
  "getstarted.heading": "Find your place on the tree",
  "getstarted.lead": "A short quiz, harvested from real lessons, to see how far you've already climbed — then a few pages to start from.",
