...
const en: Record<string, string> = {
  ...
  "feedback.placeholder": "What could be better about this page?",
  "feedback.submit": "Submit",
  "feedback.cancel": "Cancel",
  "feedback.discussLink": "Submit feedback with discussion",
  "feedback.sent": "Thanks — your feedback has been recorded.",
  "feedback.error": "Could not send right now. Your text is kept — please try again.",
  "menu.theme": "Theme",
  ...
  "theme.dark": "Dark",
  "theme.fun": "Fun",
  "voice.auto": "Automatic",
  "voice.rate": "Speed",
  "voice.pitch": "Pitch",
  "voice.test": "Test voice",
  "voice.sample": "Hello! This is how I sound.",
  "voice.unavailable": "Your browser has no speech voices installed.",
  ...
  "coursequiz.chartAria": "Concepts per star count — at the start of the quiz versus now",
  ...
  "menu.getStarted": "Getting started",

  "getstarted.docTitle": "Getting started — Interactive Primer",
  "getstarted.heading": "Getting started",
  "getstarted.lead": "Welcome to the Interactive Primer. Not sure where to start? This quick quiz works out exactly where your knowledge frontier lies, so you can dive in at the level that's just right for you. Come back here any time to broaden your frontier.",
  "getstarted.loading": "Getting ready…",
  "getstarted.fieldLegend": "What do you want to situate?",
  "getstarted.field.mathematics": "Mathematics",
  "getstarted.field.physics": "Physics",
  "getstarted.field.computer-science": "Computer science",
  "getstarted.ageLegend": "How old are you?",
  "getstarted.ageLabel": "Age",
  "getstarted.ageMax": "18+",
  "getstarted.confLegend": "How much of this field do you already know?",
  "getstarted.conf.1": "Never studied it",
  "getstarted.conf.2": "A little",
  "getstarted.conf.3": "Some of it",
  "getstarted.conf.4": "Quite a lot",
  "getstarted.conf.5": "Very confident",
  "getstarted.go": "Explore my frontier",
  "getstarted.empty": "No school-level quizzes in this field yet — try another, or start at the root.",
  "getstarted.progress": "Question {n} of about {cap}",
  "getstarted.endEarly": "That's enough — show my place",
  "getstarted.summaryTitle": "Here's where you sit",
  "getstarted.frontier": "In {field}, you're comfortable around age {n} — the typical first-encounter altitude for those ideas.",
  "getstarted.branchLine": "{branch}: strong to about {n}",
  "getstarted.branchUntested": "{branch}: untested here",
  "getstarted.branch.solid": "solid",
  "getstarted.branch.shaky": "shaky",
  "getstarted.branch.untested": "untested",
  "getstarted.noBranches": "Not enough nearby branches to map yet.",
  "getstarted.startHere": "Start here",
  "getstarted.noStarts": "Open the subject hub and pick anything that looks new.",
  "getstarted.coursesTitle": "Courses at this altitude",
  "getstarted.coursesHint": "School courses around this altitude, from every curriculum we cover. Pick the one you follow — we'll focus it on My Progress. Your stars from this quiz are already there.",
  "getstarted.noCourses": "No school course sits at this altitude yet.",
  "getstarted.courseFocused": "Focused {name}.",
  "getstarted.region.uk": "United Kingdom",
  "getstarted.region.us": "United States",
  "getstarted.region.au": "Australia",
  "getstarted.region.ca": "Canada",
  "getstarted.region.za": "South Africa",
  "getstarted.region.ib": "International Baccalaureate",
  "getstarted.openProgress": "Open My Progress",
  "getstarted.openQuiz": "Course quiz",
  "getstarted.openHub": "Subject hub",
  "getstarted.openExplore": "Explore the tree",
  "getstarted.progressTitle": "Since your last visit ({date})",
  "getstarted.progressLine": "{branch}: {from} → {to}",
  "getstarted.young.lead": "A fun quiz to see what you already know!",
  "getstarted.young.fieldLegend": "Maths, physics, or computers?",
  "getstarted.young.field.mathematics": "Maths",
  "getstarted.young.field.physics": "Physics",
  "getstarted.young.field.computer-science": "Computers",
  "getstarted.young.confLegend": "How much do you know already?",
  "getstarted.young.conf.1": "I haven't tried it yet",
  "getstarted.young.conf.2": "A little bit",
  "getstarted.young.conf.3": "Some of it",
