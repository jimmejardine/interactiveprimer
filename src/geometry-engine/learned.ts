...
export function buildAdjacency(
  graph:
    | { concepts?: Array<{ id: string; prerequisites?: string[] }> }
    | Array<{ id: string; prerequisites?: string[] }>,
): Map<string, string[]> {
 ...
 */
export function prereqClosure(adjacency: Map<string, string[]> | Record<string, string[]>, id: string): Set<string> {
  const get = (k: string) =>
 ...
 */
export function allowedTheorems(
  adjacency: Map<string, string[]> | Record<string, string[]>,
  id: string,
  ruleConceptIds: Iterable<string>,
