 ...
 */
function parseRefs(html: string): { id: string, forward: boolean, soft: boolean, todo: boolean }[] {
  const body = html.replace(COMMENT, "");
  const out: { id: string, forward: boolean, soft: boolean, todo: boolean }[] = [];
 ...
 */
export function extractConceptRefs(html: string): string[] {
 ...
 */
export function extractForwardRefs(html: string): string[] {
 ...
 */
export function extractSoftRefs(html: string): string[] {
 ...
 */
export function extractTodoRefs(html: string): string[] {
 ...
 */
export function extractCourseMembers(html: string): string[] {
